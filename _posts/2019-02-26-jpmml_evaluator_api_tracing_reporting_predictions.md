...
* [`feature`](http://dmg.org/pmml/v4-3/Output.html#xsdType_RESULT-FEATURE) - Fixed as `x-report`. The "x-" prefix to the attribute value indicates that this is a vendor extension.
...
* The vendor-extended PMML document: ["XGBoostAudit-reporting.pmml"]({{ site.baseurl }}/assets/2019-02-26/XGBoostAudit-reporting.pmml)