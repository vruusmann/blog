...
The parent construct is the `PMML` element. According to the [general structure](http://dmg.org/pmml/v4-3/GeneralStructure.html), the first child element of the `PMML` element must be a [`Header`](http://dmg.org/pmml/v4-3/Header.html#xsdElement_Header) element, which provides a general description of the model.
...
The parent construct is the [`Characteristic`](http://dmg.org/pmml/v4-3/Scorecard.html#xsdElement_Characteristic) element, which belongs to the [`Scorecard`](http://dmg.org/pmml/v4-3/Scorecard.html#xsdElement_Characteristic) element.
